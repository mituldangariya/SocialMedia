...
public partial class SocialMediaAppEntities : DbContext
{
    ...
    public virtual int AddComment(Nullable<int> postId, Nullable<int> userId, string commentText, Nullable<int> parentCommentId)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddComment", postIdParameter, userIdParameter, commentTextParameter, parentCommentIdParameter);
    }
